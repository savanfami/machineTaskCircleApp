...
export const CircleContainer: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            >
                <h3 className="text-grey-500" style={{ margin: "0", fontSize: "16px", textDecoration: 'underline', fontFamily: 'initial', color: 'darkblue' }}>Here You Can Create Circles - Max 2!!!</h3>
